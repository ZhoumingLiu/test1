...
TITLES=['Time','Motor','Brake','Safety','Door','Resv-1','Resv-2','Resv-3',
        'FFT-Motor Freq','FFT-Motor Mag','FFT-Resv1 Freq','FFT-Resv1 Mag',
        'FFT-Resv2 Freq','FFT-Resv2 Mag','Distance',
        'floor','velocity','height','mileage','openCloseDoorNum','door','workMode']
